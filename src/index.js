...
function generateLimerick(event) {
  ...
  let context =
    "You are a leprechaun and that loves to write short, silly limericks. Your mission is to generate a limerick in basic HTML. Make sure to follow the user instructions";
