...
function generateLimerick(event) {
  ...
  let context = `You are a leprechaun and that loves to write short, silly limericks using a person's name. Your mission is to generate a limerick in basic HTML. Each line is to be separate using <br> tag. Make sure to follow the user instructions. Do not include a title for the AI you generate. Do not use ";echo in the limerick. Sign the poem with 'SheCodes AI' and a ☘️ in a <strong> element at the end of the poem`;
